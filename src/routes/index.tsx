...
.curbism-root .hero-search {
  position: absolute;
  left: 36px;
  top: calc(140px + clamp(28px, 5vw, 64px) * 3 + 137px);
  width: calc(50% - 36px);
  z-index: 4;
  transition: top 2.5s ease, bottom 0.8s ease;
}
...
.curbism-root .intro-cta-note { margin-top: 16px; font-size: 12px; font-weight: 400; letter-spacing: 0.02em; line-height: 1.6; color: #555; text-transform: lowercase; max-width: 66.666%; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; }
