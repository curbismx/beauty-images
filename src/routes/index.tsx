...
.curbism-root .intro-text p { font-size: 16px; font-weight: 400; text-transform: none; letter-spacing: normal; line-height: 1.6; color: #555; font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; }
...
@media (max-width: 768px) {
  ...
  .curbism-root .intro-text p { font-size: 15px; }
