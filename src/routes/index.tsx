        ...
        <div className="home-stack">
          <div className={`home-fade${searchActive ? " home-fade--hidden" : ""}`}>
            ...
            <div className="intro-text">
              ...
              <p>
                PROVIDING IMAGES TO HIGH-END PUBLICATIONS AND ADVERTISING FOR OVER 20 YEARS. ALL OUR IMAGES ARE EXCLUSIVE TO BEAUTY IMAGES AND ARE SOLD ON A RIGHTS MANAGED BASIS. ALL REAL PEOPLE. REAL PHOTOGRAPHY. WITH NO AI PRODUCTION AT ALL.
              </p>
            </div>
